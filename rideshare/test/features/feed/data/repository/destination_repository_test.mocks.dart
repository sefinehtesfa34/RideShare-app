...
// in rideshare/test/features/feed/data/repository/destination_repository_test.dart.
...
import 'package:rideshare/core/network/network_info.dart' as _i2;
...
class MockDestinationDataSource extends _i1.Mock
    implements _i4.DestinationDataSource {
  MockDestinationDataSource() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<List<_i5.Destination>> fetchPassengerHistory() =>
      (super.noSuchMethod(
        Invocation.method(
        ...
        returnValue:
            _i3.Future<List<_i5.Destination>>.value(<_i5.Destination>[]),
      ) as _i3.Future<List<_i5.Destination>>);
}
